  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" dir="rtl">
      ...
      >
        ...
        {/* Islamic star */}
        <svg width="24" height="24" viewBox="0 0 40 40" className="mx-auto mb-3 text-primary opacity-40">
  ...
  return (
    <div className="h-screen flex flex-col max-w-lg mx-auto bg-background" dir="rtl">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
        {!locationRequested && !showLocationDialog ? null
          : !isSupported ? (
          ...
          <div className="text-primary font-bold animate-pulse" style={{ fontFamily: '"Tajawal", sans-serif' }}>جاري تحديد الموقع...</div>
        ) : geoError ? (
          ...
          <div className="text-muted-foreground" style={{ fontFamily: '"Tajawal", sans-serif' }}>اضغط للسماح بتحديد موقعك</div>
        ) : (
          <>
            {/* Status */}
            <div className="mb-8">
              {isAligned ? (
                ...
                <div className="bg-primary/5 border border-primary/20 text-foreground px-6 py-3 rounded-2xl">
                  ...
                  <p className="text-sm text-muted-foreground mt-1" style={{ fontFamily: '"Tajawal", sans-serif' }}>زاوية القبلة: {Math.round(qiblaAngle)}° من الشمال</p>
                </div>
              )}
            </div>
